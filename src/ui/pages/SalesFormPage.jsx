...
export default function SalesFormPage() {
    ...
    const validate = () => {
        const nextErrors = {};
        if (!form.client_id) nextErrors.client_id = 'Seleccióna un cliente';
        if (!form.product_id) nextErrors.product_id = 'Seleccióna un producto';
        if (!form.quantity || Number(form.quantity) <= 0) nextErrors.quantity = 'Ingresa una cantidad válida';
        if (!form.sold_at) nextErrors.sold_at = 'Seleccióna una fecha';
        if (
            form.sold_at &&
        ...
        if (form.paid === '1' && !form.payment_source) {
            nextErrors.payment_source = 'Seleccióna un origen de pago';
        }
                ...
                >
                    ...
                    <div className="form-grid">
                        ...
                        <label className="field field--full">
                            ...
                            >
                                <option value="">Seleccióna origen</option>
