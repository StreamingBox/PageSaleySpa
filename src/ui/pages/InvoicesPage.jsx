    ...
    const columns = [
        {
            ...
            label: (
                <input
                    aria-label="Seleccionar cuentas de cobro visibles"
        ...
        <div className="page-stack">
            ...
            {selectedInvoices.length ? (
                <section className="range-banner">
                    <div>
                        <strong>{selectedInvoices.length} cuentas de cobro seleccionadas</strong>
                        <p className="summary-note">
                            {selectedClientIds.length > 1
                                ? 'La selección actual mezcla clientes distintos. Elige solo cuentas de cobro del mismo cliente.'
                                : `Se conservará ${primaryInvoice?.invoice_number} y se moverán allí las líneas de las demás cuentas de cobro pendientes seleccionadas.`}
                        </p>
                    </div>
            ...
            <ConfirmDialog
                ...
                title="Unificar cuentas de cobro seleccionadas"
                description={
                    selectedInvoices.length < 2
                        ? 'Selecciona al menos dos cuentas de cobro pendientes del mismo cliente.'
                        : selectedClientIds.length > 1
